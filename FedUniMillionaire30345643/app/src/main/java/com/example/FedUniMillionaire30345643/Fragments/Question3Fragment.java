...
public class Question3Fragment extends Fragment implements View.OnClickListener {
    ...
    public Question3Fragment(ArrayList<Question> questions, int savings){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String q = questions.get(2).getQ();
        String a = questions.get(2).getOptions().get(0).getValue();
        String b = questions.get(2).getOptions().get(1).getValue();
        String c = questions.get(2).getOptions().get(2).getValue();
        String d = questions.get(2).getOptions().get(3).getValue();
        int balance = 998000;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.answerA:
                ...
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.question_fragment, new Question4Fragment(questions, savings))
                        .commit();
                break;
            case R.id.answerC:
            case R.id.answerD:
