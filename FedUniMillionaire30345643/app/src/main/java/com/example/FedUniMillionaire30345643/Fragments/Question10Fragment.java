...
public class Question10Fragment extends Fragment implements View.OnClickListener {
    ...
    public Question10Fragment(ArrayList<Question> questions, int savings){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String q = questions.get(9).getQ();
        String a = questions.get(9).getOptions().get(0).getValue();
        String b = questions.get(9).getOptions().get(1).getValue();
        String c = questions.get(9).getOptions().get(2).getValue();
        String d = questions.get(9).getOptions().get(3).getValue();
        int balance = 750000;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.answerA:
                ...
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.question_fragment, new Question11Fragment(questions, savings))
                        .commit();
                break;
            case R.id.answerC:
            case R.id.answerD:
