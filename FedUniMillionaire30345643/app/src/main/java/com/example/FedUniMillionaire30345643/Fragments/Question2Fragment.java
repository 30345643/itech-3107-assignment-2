...
public class Question2Fragment extends Fragment implements View.OnClickListener {
    ...
    public Question2Fragment(ArrayList<Question> questions, int savings){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String q = questions.get(1).getQ();
        String a = questions.get(1).getOptions().get(0).getValue();
        String b = questions.get(1).getOptions().get(1).getValue();
        String c = questions.get(1).getOptions().get(2).getValue();
        String d = questions.get(1).getOptions().get(3).getValue();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.answerD:
                ...
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.question_fragment, new Question3Fragment(questions, savings))
                        .commit();
                break;
        }
    }
