...
public class Question5Fragment extends Fragment implements View.OnClickListener {
    ...
    public Question5Fragment(ArrayList<Question> questions, int savings){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String q = questions.get(4).getQ();
        String a = questions.get(4).getOptions().get(0).getValue();
        String b = questions.get(4).getOptions().get(1).getValue();
        String c = questions.get(4).getOptions().get(2).getValue();
        String d = questions.get(4).getOptions().get(3).getValue();
        int balance = 992000;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.answerB:
                ...
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.question_fragment, new Question6Fragment(questions, savings))
                        .commit();
                break;
        }
    }
