...
public class Question6Fragment extends Fragment implements View.OnClickListener {
    ...
    public Question6Fragment(ArrayList<Question> questions, int savings){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.question6_fragment, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String q = questions.get(5).getQ();
        String a = questions.get(5).getOptions().get(0).getValue();
        String b = questions.get(5).getOptions().get(1).getValue();
        String c = questions.get(5).getOptions().get(2).getValue();
        String d = questions.get(5).getOptions().get(3).getValue();
        int balance = 984000;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.answerC:
                ...
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.question_fragment, new SaveFive(questions, savings))
                        .commit();
                break;
        }
    }
