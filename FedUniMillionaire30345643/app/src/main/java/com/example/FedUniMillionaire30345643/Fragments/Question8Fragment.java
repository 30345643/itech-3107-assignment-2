...
public class Question8Fragment extends Fragment implements View.OnClickListener {
    ...
    public Question8Fragment(ArrayList<Question> questions, int savings){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String q = questions.get(7).getQ();
        String a = questions.get(7).getOptions().get(0).getValue();
        String b = questions.get(7).getOptions().get(1).getValue();
        String c = questions.get(7).getOptions().get(2).getValue();
        String d = questions.get(7).getOptions().get(3).getValue();
        int balance = 936000;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.answerB:
                ...
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.question_fragment, new Question9Fragment(questions, savings))
                        .commit();
                break;
        }
    }
