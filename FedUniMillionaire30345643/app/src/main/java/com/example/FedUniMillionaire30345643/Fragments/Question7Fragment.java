...
public class Question7Fragment extends Fragment implements View.OnClickListener {
    ...
    public Question7Fragment(ArrayList<Question> questions, int savings){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String q = questions.get(6).getQ();
        String a = questions.get(6).getOptions().get(0).getValue();
        String b = questions.get(6).getOptions().get(1).getValue();
        String c = questions.get(6).getOptions().get(2).getValue();
        String d = questions.get(6).getOptions().get(3).getValue();
        int balance = 968000;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.answerC:
                ...
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.question_fragment, new Question8Fragment(questions, savings))
                        .commit();
                break;
            case R.id.answerA:
            case R.id.answerD:
