...
public class SaveFive extends Fragment implements View.OnClickListener{

    ArrayList<Question> questions = new ArrayList<Question>();
    int savings;

    public SaveFive(ArrayList<Question> questions, int savings){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.question6_savings_fragment, container, false);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.saveYes:
                ...
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.question_fragment, new Question7Fragment(questions, savings))
                        .commit();
